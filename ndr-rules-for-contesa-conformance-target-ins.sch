<?xml version="1.0" encoding="UTF-8"?><sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2"><sch:title>Rules for instance XML documents</sch:title><xsl:include href="ndr-functions.xsl"/>
...
<sch:pattern id="rule_12-2"><sch:title>Element with structures:ref does not have content</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_12-2</sch:p>
...
<sch:pattern id="rule_12-3"><sch:title>Attribute structures:ref must reference structures:id</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_12-3</sch:p>
  <sch:rule context="*[@structures:ref]">
...
<sch:pattern id="rule_12-13"><sch:title>Attribute structures:metadata references metadata element</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_12-13</sch:p>
...
<sch:pattern id="rule_12-14"><sch:title>Attribute structures:relationshipMetadata references metadata element</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_12-14</sch:p>
