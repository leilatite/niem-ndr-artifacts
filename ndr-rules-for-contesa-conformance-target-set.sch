<?xml version="1.0" encoding="UTF-8"?><sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2"><sch:title>Rules for XML Schema document sets</sch:title><xsl:include href="ndr-functions.xsl"/>
...
<sch:pattern id="rule_9-31"><sch:title>Base type of complex type with complex content must have complex content</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_9-31</sch:p>
...
<sch:pattern id="rule_10-12"><sch:title>External adapter type not a base type</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_10-12</sch:p>
...
<sch:pattern id="rule_10-71"><sch:title>appinfo:appliesToTypes references types</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_10-71</sch:p>
...
<sch:pattern id="rule_10-73"><sch:title>appinfo:appliesToElements references elements</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_10-73</sch:p>
...
<sch:pattern id="rule_11-17"><sch:title>Name of element declaration with simple content has representation term</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_11-17</sch:p>
...
<sch:pattern id="rule_11-36"><sch:title>Reference schema imports reference schema</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_11-36</sch:p>
...
<sch:pattern id="rule_11-37"><sch:title>Extension schema document imports reference or extension schema</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_11-37</sch:p>
...
<sch:pattern id="rule_11-40"><sch:title>Each namespace may have only a single root schema in a schema set</sch:title><sch:p>http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/NIEM-NDR-3.0-2014-07-31.html#rule_11-40</sch:p>
