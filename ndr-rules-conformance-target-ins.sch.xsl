...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">Element with structures:ref does not have content</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule_12-14</xsl:attribute>
   ...
   <!--PATTERN rule_12-2Element with structures:ref does not have content-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Element with structures:ref does not have content</svrl:text>

	  <!--RULE -->
   <xsl:template match="*[@structures:ref]" priority="1000" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[@structures:ref]"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(element() | text())"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 12-2: An element that has attribute structures:ref MUST NOT have element or text content.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M12"/>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Attribute structures:ref must reference structures:id</svrl:text>
	  ...
	  <!--RULE -->
   <xsl:template match="*[@structures:ref]" priority="1000" mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[@structures:ref]"/>
   ...
   <!--PATTERN rule_12-13Attribute structures:metadata references metadata element-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Attribute structures:metadata references metadata element</svrl:text>

	  <!--RULE -->
   <xsl:template match="*[exists(@structures:metadata)]" priority="1000" mode="M14">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 12-13: Each item in the value of an attribute structures:metadata MUST appear as the value of an attribute structures:id with an owner element that is a metadata element.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M14"/>
   ...
   <!--PATTERN rule_12-14Attribute structures:relationshipMetadata references metadata element-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 12-14: Each item in the value of an attribute structures:relationshipMetadata MUST appear as the value of an attribute structures:id with an owner element that is a metadata element.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M15"/>
